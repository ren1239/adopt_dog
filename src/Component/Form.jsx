...
function Form() {
  return (
    <form className="  m-16 bg-lightest p-6 rounded-lg">
      <div className="space-y-12">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 pb-12 md:grid-cols-3">
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-gray-600 mx-4">
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2">
                <textarea
                  ...
                  defaultValue={""}
                  placeholder="Write a few sentences about them. "
                />
              </div>
            </div>
          ...
          <div className="border-b mx-36 border-medium"></div>
        </div>
